...
Vue.component('listdata', __webpack_require__(/*! ./components/List.vue */ "./resources/js/components/List.vue").default); // App id
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "relative w-5/6 ml-32 flex flex-col divide-y" },
    [
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "h-9/12 mb-10" }, [
        _c(
          "table",
          { staticClass: "w-full top-40 left-32 border bg-green-400" },
          [
            _vm._m(1),
            _vm._v(" "),
            _c("tbody", [
              _c("tr", { staticClass: "border-b mb-100" }, [
                _c(
                  "th",
                  {
                    staticClass:
                      "p-2 border-r cursor-pointer font-thin text-20 text-white"
                  },
                  [_vm._v(_vm._s(_vm.$i))]
                ),
                _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "h-3/12 pb-4" }, [
      _c(
        "button",
        {
          staticClass:
            "bg-green-500 hover:bg-green-700 h-10 w-24 \n            rounded-xl"
        },
        [_vm._v("\n            Save New\n        ")]
      )
    ])
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", { staticClass: "border-b" }, [
        _c(
          "th",
          { staticClass: "p-2 border-r cursor-pointer font-bold text-black" },
          [_vm._v("Name")]
        ),
        _vm._v(" "),
        _c(
